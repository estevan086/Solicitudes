sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/Solicitudes/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.Solicitudes.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/Solicitudes/localService/mockserver"], function (mockserver) {
